...
The content repo associated with this book is [pivotal-cf/docs-csb-gcp](https://github.com/pivotal-cf/docs-csb-gcp).
For specific information about Tanzu Cloud Service Broker for GCP documentation,
see [Tanzu Cloud Service Broker for GCP Docs](https://github.com/pivotal-cf/docs-csb-gcp/blob/master/README.md).
...
Here you'll find the configuration and templates for the Tanzu Cloud Service Broker for GCP documentation set published to [docs.pivotal.io/csb-gcp/](http://docs.pivotal.io/csb-gcp/).
...
For example: `r302 %r{/csb-gcp/(?![\d-]+)(.*)}, "/csb-gcp/1-0/$1"`
...
* [docs-csb-gcp](https://github.com/pivotal-cf/docs-csb-gcp)
